...
/*6. Crear una estructura llamada alumno con sus atributos persona (del anterior), y un arreglo de una dimensión con las materias que cursa y otro 
arreglo de una dimensión con las notas de los finales. (Ej. historial académico). Cargue con datos y luego muéstrelos.*/
